...
const q04 = {
  ...
  relevantContent: Filters.answeredQuestion<PhotoContent>(
    "q02",
    QuestionParts.choiceId(q02, "Amphibian"),
  ),
...
const q06 = {
  ...
  relevantContent: Filters.answeredQuestion<PhotoContent>(
    "q02",
    QuestionParts.choiceId(q02, "Bird"),
  ),
...
const q08 = {
  ...
  relevantContent: Filters.answeredQuestion<PhotoContent>(
    "q07",
    QuestionParts.choiceId(q07, "Yes"),
  ),
...
const q09 = {
  ...
  relevantContent: Filters.answeredQuestion<PhotoContent>(
    "q01",
    QuestionParts.choiceId(q01, "Cityscape"),
  ),
...
const q10 = {
  ...
  relevantContent: Filters.answeredQuestion<PhotoContent>(
    "q09",
    QuestionParts.choiceId(q09, "Waterways"),
  ),
...
const q14 = {
  ...
  text: "What is the binomial name of the bird?"
};
